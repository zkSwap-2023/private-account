...
const CONTRACT_ADDRESS = process.env.MIXER
const AMOUNT = '1'
// CURRENCY = 'ETH'
...
async function deposit() {
  ...
  const tx = await contract.methods
    ...
    .send({ value: 0, from: web3.eth.defaultAccount, gas: 2e6 })
...
async function main() {
  ...
  contract = new web3.eth.Contract(require('../build/contracts/ERC20Tornado.json').abi, CONTRACT_ADDRESS)
